...
<ModeWatcher />
<Button ghost icon onclick={handleModeChange}>
	{#if $mode === 'light'}
...
<!-- 
<button class="btn btn-primary" onclick={() => setMode('light')}>Set Light Mode</button>
<button class="btn btn-primary" onclick={() => setMode('dark')}>Set Dark Mode</button> -->
